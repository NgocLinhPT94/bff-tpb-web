...
describe('mapAbout', () => {
  it('maps null dynamic zone relation to an empty array', () => {
    ...
    ).toEqual({ documentId: 'about-doc', title: 'About', blocks: [] });
  });
  ...
  it('strips internal metadata from blocks', () => {
    expect(
      mapAbout({
        documentId: 'about-doc',
        blocks: [{ id: 7, __component: 'shared.rich-text', body: 'Hello', createdAt: 'internal' }],
      }),
    ).toEqual({
      documentId: 'about-doc',
